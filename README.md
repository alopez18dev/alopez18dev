# ¡Hola! Soy Alejandro López Tascón

Desarrollador Web enfocado en crear soluciones tecnológicas eficientes mediante el uso de Inteligencia Artificial. Me especializo en transformar ideas de negocio en aplicaciones funcionales y escalables.

## Tecnologías y Herramientas
* **Frontend:** React, TypeScript, HTML, CSS.
* **Backend & Cloud:** Firebase (Firestore, Auth, Hosting), Cloudinary.
* **Productividad:** Cursor AI, Git, GitHub.
